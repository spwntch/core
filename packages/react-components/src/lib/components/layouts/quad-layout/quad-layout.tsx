  ...
  (
    ...
    return (
      <div
        ...
        {...props}
      >
        <div className={cn(styles['pane'], flipQuadrants[0] && styles['flip'])}>
          {containers ? containers[0] : 'Pane One'}
        </div>
        <div className={cn(styles['pane'], flipQuadrants[1] && styles['flip'])}>
          {containers ? containers[1] : 'Pane Two'}
        </div>
        <div className={cn(styles['pane'], flipQuadrants[2] && styles['flip'])}>
          {containers ? containers[2] : 'Pane Three'}
        </div>
        <div className={cn(styles['pane'], flipQuadrants[3] && styles['flip'])}>
