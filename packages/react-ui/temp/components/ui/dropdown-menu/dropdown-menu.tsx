...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ...
    className={cn(
      styles['sub-trigger'],
      inset && styles['sub-trigger__inset'],
      className
    )}
    {...props}
  >
    {children}
    <ChevronRight className={styles['sub-trigger__chevron-right']} />
  </DropdownMenuPrimitive.SubTrigger>
));
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(styles.item, inset && styles['item__inset'], className)}
    {...props}
  />
));
