...
>(({ side = 'right', className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    >
      {children}
      <SheetPrimitive.Close className={styles['sheet-content']}>
        <X className={styles['sheet-content__close-icon']} />
        <span className={styles['sheet-content__screen-reader-only']}>
          Close
        </span>
