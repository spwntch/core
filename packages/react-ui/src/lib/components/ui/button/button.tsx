 ...
 * @param {string} [props.variant] - Variant style of the button (default, destructive, outline, secondary, ghost, link)
 * @param {string} [props.size] - Size of the button (default, sm, lg, icon)
 * @param {boolean} [props.asChild] - Whether the button should be rendered as a child component
